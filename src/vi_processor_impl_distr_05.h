// Header of fifth implementation

// be sure class is defined
#ifndef __VI_PROCESSOR_IMPL_DISTR_05_H
#define __VI_PROCESSOR_IMPL_DISTR_05_H
// includes
 ...
 */
class VI_Processor_Impl_Distr_05 : public VI_Processor_Base
{
public:
    /**
     * Constructor of fifth implementation
     ...
     */
    VI_Processor_Impl_Distr_05(const vi_data_args_t& args, const int root_id, int _comm_period = 100)
